...
Inconsistent naming across files and repositories leads to pipeline friction and "where is that file?" fatigue. We need a standardized grammar for Case 01 and beyond.
